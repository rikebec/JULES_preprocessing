...
land_frac_img = "~/JULES_preprocessing/Output/netcdf/jules_land_frac_wrf_dar_d04.nc" 
# to the shapefile
...
land_frac_nc.to_netcdf("~/JULES_preprocessing/Output/netcdf/jules_land_frac_wrf_dar_d04_clipped.nc")
