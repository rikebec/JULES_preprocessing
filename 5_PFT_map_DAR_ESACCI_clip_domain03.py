...
wrf_path = "~/JULES_preprocessing/Output/netcdf/jules_land_frac_lcc_dar_d03.nc" #to get the extent of the WRF domain
...
pft_clipped.to_netcdf("~/JULES_preprocessing/Output/netcdf/pft_clipped_d03_wgs84.nc")
