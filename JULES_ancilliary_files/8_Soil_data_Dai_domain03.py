...
hcap_dai = I_directory+'csol_d03/hcap_d03_lcc.nc'
...
soil = xr.open_dataset('~/JULES_preprocessing/Output/netcdf/jules_soil_lcc_dar_d03.nc')
...
hcon_dai = I_directory+'tkdry_d03/hcon_d03_lcc.nc'
...
#%% save as netCDF file to be used in JULES
output = 'jules_soil_lcc_dar_d03_Dai.nc'
