...
Description: script to create the soil input netcdf for JULES

Soil Albedo is taken from Houldcroft et al. (2009) https://doi.org/10.1175/2008JHM1021.1

For all other prameters the script reads the HiHydroSoil-data and SoilGrids-data, which was clipped to the DAR domain 
and upscaled from 30 m x 30 m to 1 km x 1 km using Google Earth Engine (see Colab notebook in git repository). 
The code extracts, stacks, calculates and resamples the required soil information to match the 4x4km WRF grid for Deplete and Retreat
...
albedo_clipped.rio.to_raster(O_directory+'soil_albedo_d03.tif')

# downscale to the resolution of 250m to match the SoilGrids and HiHydro data sets
# resampling 
reference_tif = I_directory_2+'Ksat_d03_0.tif'
target_tif = O_directory+'soil_albedo_d03.tif'
output_tif = O_directory+'soil_albedo_d03_resample.tif'
...
soil_albedo = np.reshape(soil_albedo, (4714,2061))
...
#%% ### sm_crit ###
file_names = ['Sm_crit_d03_0.tif', 'Sm_crit_d03_1.tif', 'Sm_crit_d03_2.tif', 'Sm_crit_d03_3.tif', 'Sm_crit_d03_4.tif', 'Sm_crit_d03_5.tif']
...
#%% ### sm_sat ###
file_names = ['Sm_sat_d03_0.tif', 'Sm_sat_d03_1.tif', 'Sm_sat_d03_2.tif', 'Sm_sat_d03_3.tif', 'Sm_sat_d03_4.tif', 'Sm_sat_d03_5.tif']
...
#%% ### sm_wilt ###
file_names = ['Sm_wilt_d03_0.tif', 'Sm_wilt_d03_1.tif', 'Sm_wilt_d03_2.tif', 'Sm_wilt_d03_3.tif', 'Sm_wilt_d03_4.tif', 'Sm_wilt_d03_5.tif']
...
#%% ### satcon ###
file_names = ['Ksat_d03_0.tif', 'Ksat_d03_1.tif', 'Ksat_d03_2.tif', 'Ksat_d03_3.tif', 'Ksat_d03_4.tif', 'Ksat_d03_5.tif']
...
#%% ### alpha ### in 1/cm
file_names = ['Alpha_d03_0.tif', 'Alpha_d03_1.tif', 'Alpha_d03_2.tif', 'Alpha_d03_3.tif', 'Alpha_d03_4.tif', 'Alpha_d03_5.tif']
...
file_name = 'Silt_d03.tif'
reference_tif = I_directory+'Ksat_d03_0.tif'
target_tif = I_directory+file_name
output_tif = I_directory+'silt_d03_resample.tif'
...
file_name = 'Clay_d03.tif'
reference_tif = I_directory+'Ksat_d03_0.tif'
target_tif = I_directory+file_name
output_tif = I_directory+'clay_d03_resample.tif'
...
file_name = 'soc_d03.tif'
reference_tif = I_directory+'Ksat_d03_0.tif'
target_tif = I_directory+file_name
output_tif = I_directory+'soc_d03_resample.tif'
...
file_name = 'cec_d03.tif'
reference_tif = I_directory+'Ksat_d03_0.tif'
target_tif = I_directory+file_name
output_tif = I_directory+'cec_d03_resample.tif'
...
file_name = 'pH_d03.tif'
reference_tif = I_directory+'Ksat_d03_0.tif'
target_tif = I_directory+file_name
output_tif = I_directory+'pH_d03_resample.tif'
...
file_name = 'bd_d03.tif'
reference_tif = I_directory+'Ksat_d03_0.tif'
target_tif = I_directory+file_name
output_tif = I_directory+'bd_d03_resample.tif'
...
Nc_img.to_netcdf("~/JULES_preprocessing/Output/netcdf/Soil_test_d03.nc")
...
img_clipped.to_netcdf("~/JULES_preprocessing/Output/netcdf/jules_soil_wgs84_dar_d03.nc")
...
output = 'jules_soil_lcc_dar_d03.nc'
